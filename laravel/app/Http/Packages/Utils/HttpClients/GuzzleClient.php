...
class GuzzleClient implements ClientInterface
{
     ...
     * @return array
     */
    public function request($verb, $url, $headers = array(), $body = array())
    {
        /**
         ...
         * the client when I feel like this serves my purposes and I've made my point about interfaces and dependency
         * injection.
         *
